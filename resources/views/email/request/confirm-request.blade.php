                            ...
                            <table cellspacing="0" cellpadding="0" class="force-full-width" bgcolor="#ffffff">
                                <tr>
                                    <td style="background-color:#ffffff; padding: 0 20px">
                                        ...
                                        <br>
                                        <p>
                                            Yêu cầu của bạn đã được chấp nhận. Bạn có thể vào trang cá nhân để xem sản
                                            phẩm. Bạn có thể liên hệ với chủ sở hữu để hẹn thời gian gặp mặt giao dịch sản phẩm.
                                            Tên chủ sở hữu <b>{{$fullname}}</b> . Số điện thoại <b>{{$phone}}</b>
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            <table style="margin:0 auto;" cellspacing="0" cellpadding="0" class="force-full-width"
                                   bgcolor="#ffffff">
                                <tr>
                                    <td style="text-align:center; margin:0 auto;">
                                        ...
                                        <br>
                                        <a href="http://"
                                           style="background-color:#f5774e;color:#ffffff;display:inline-block;font-family:'Source Sans Pro', Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:45px;text-align:center;text-decoration:none;width:220px;-webkit-text-size-adjust:none;">Website</a>
                                        <br>
                                        <br>
                                        <br>
                                    </td>
