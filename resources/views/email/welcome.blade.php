                                            ...
                                            <tr>
                                                ...
                                                <td width="360" class="w320">
                                                    <table cellspacing="0" cellpadding="0" class="w280 w100p">
                                                        <tr>
                                                            <td class="mobile-center activate-now"
                                                                style="color:#27aa90; font-size: 30px; font-weight: 600; line-height:30px; text-align:left;">
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="100%">
                                            <tr>
                                                <td style="text-align:left;" class="mobile-center body-padding w320">
                                                    ...
                                                    eiusmod tempor ullamco laboris.
                                            ...
                                            <tr>
                                                <td style="text-align:center; margin:0 auto;">
                                                    ...
                                                    <div><!--[if mso]>
                                                        ...
                                                        <![endif]-->
                                                        <a href="http://"
                                                           style="background-color:#f5774e;color:#ffffff;display:inline-block;font-family:'Source Sans Pro', Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:45px;text-align:center;text-decoration:none;width:180px;-webkit-text-size-adjust:none;">Activate
                                                            Account</a>
                                                        <!--[if mso]>
                                                        </center>
                                                        </v:rect>
